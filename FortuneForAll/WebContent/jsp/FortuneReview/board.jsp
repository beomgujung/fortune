...
내용
  ...
  <br><br>
  <p align="left">
  <button type="button"  onclick="location.href='../FortuneReview/fortunereview.jsp'">목록으로</button>
  </p>
  <p align="right">
  <form method="POST" action="/FortuneForAll/com.fortuneforall.fortunereview.controller/FortuneReviewUpWriteController?num=${board.board_no}&content=${board.content}&title=${board.title}">
  <button>수정</button>
  </form>
  <form method="POST" action="/FortuneForAll/com.fortuneforall.fortunereview.controller/FortuneReviewDeleteController?num=${board.board_no}">
  <button>삭제</button>
  </form>
  </p></div>
  </div>
